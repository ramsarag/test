...
public class TestGraph {
	...
	static void hamCircuit(HGraph g){
		// vertex count
		int V = g.getvCount();
		...
		if(solveHamCircuit(V, g, path, 3) == false){
	...
	static boolean canBeAdded(int v, HGraph g, int path[], int pos){
	...
	static boolean solveHamCircuit(int V, HGraph g, int path[], int pos){
